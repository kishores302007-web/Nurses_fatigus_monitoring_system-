...
export const AdminPanel: React.FC = () => {
  ...
  return (
    <div className="h-full space-y-6 overflow-y-auto px-8 py-6 bg-slate-50 text-slate-800">
      ...
      {successMsg && (
        <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-xs font-bold text-emerald-800 flex items-center gap-1.5 shadow-sm animate-in fade-in slide-in-from-top-4 duration-200">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 text-left">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
          ...
          <form onSubmit={handleAddNurse} className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-left">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-400 uppercase">Qualification Category</label>
              <input
                type="text"
                disabled
                value={nurseForm.skill_category}
                className="w-full rounded-lg border border-slate-200 p-2 text-xs bg-slate-100 text-slate-500"
              />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-400 uppercase">Max Shift Limit (Hours)</label>
              <input
                type="number"
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
          ...
          <div className="space-y-4 text-left">
            ...
            <button
              ...
              className="mt-2 w-full rounded-lg bg-slate-800 hover:bg-slate-900 px-4 py-2.5 text-xs font-bold text-white transition shadow-sm flex items-center justify-center gap-1.5"
            >
              <Save size={14} />

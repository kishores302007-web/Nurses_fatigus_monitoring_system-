...
export const FatigueMonitoring: React.FC<FatigueMonitoringProps> = ({ selectedNurse, onSelectNurse }) => {
  ...
  const getDialColor = (score: number) => {
    ...
    return 'stroke-pink-500 text-pink-600';
  };
    ...
    <div className="h-full space-y-6 overflow-y-auto px-8 py-6 bg-slate-50 text-slate-800">
      ...
      <div className="flex flex-col gap-4 border-b border-slate-200 pb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <label className="text-xs font-bold text-slate-400 uppercase">Select Nurse:</label>
          <select
              ...
              <div className="space-y-4 text-left">
                <div>
                  <div className="flex justify-between text-xs font-semibold text-slate-500 mb-1">
                    ...
                    <span className={predictions.predicted_2h > 75 ? 'text-pink-600 font-bold' : 'text-slate-800'}>
                ...
                <div>
                  <div className="flex justify-between text-xs font-semibold text-slate-500 mb-1">
                    ...
                    <span className={predictions.predicted_4h > 75 ? 'text-pink-600 font-bold' : 'text-slate-800'}>
                ...
                <div>
                  <div className="flex justify-between text-xs font-semibold text-slate-500 mb-1">
                    ...
                    <span className={predictions.predicted_end_shift > 75 ? 'text-pink-600 font-bold' : 'text-slate-800'}>
                    ...
                    <div className="h-36 w-full text-left">
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={history}>
                          ...
                          <Tooltip />
                          <Line type="monotone" dataKey="heart_rate" stroke="#ec4899" strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
